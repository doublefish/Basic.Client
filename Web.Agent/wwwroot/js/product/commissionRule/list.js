layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'list', 'dialog'], function () {
	...
	list.init({
		...
		cols: [[
			...
			{ field: 'Rate', title: '佣金比例', width: 105, sort: true, align: 'right', templet: function (d) { return d.Rate ? (d.Rate * 100).ToStringForFloat() + '%' : '--'; } },
			{ field: 'Amount', title: '佣金金额', width: 105, sort: true, align: 'right', templet: function (d) { return d.Amount ? d.Amount.ToStringForFloat() : '--'; } },
