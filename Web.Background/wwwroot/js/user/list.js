layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'list', 'dialog'], function () {
	...
	list.init({
		...
		cols: [[
			...
			{ field: 'RoleNames', title: '角色', width: 120, unresize: true, templet: function (d) { return d.RoleNames.join('/'); } },
			{
				field: 'StatusNote', title: '状态', width: 95, unresize: true, templet: function (d) {
					var html = '';
					if (HasRight('user/updateStatus')) {
